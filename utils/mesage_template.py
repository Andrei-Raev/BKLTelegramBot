...
EMPTY_INVITE = escape_markdown(
    'Добро пожаловать в бота XPEvent!\nПройдите регестрацию на турнир, следуюя инструкциям.')
...
ASK_POLICY = escape_markdown(
    'Для продолжения вы должны согласиться с политикой конфиденциальности и обработки персональных данных\\.')
